...
select c.idCommande,dateCommande,sum(qteAchat) as quantite from commande c inner join detailCommande dc on dc.idCommande=c.idCommande where idClient=13 and c.idCommande=23 group by c.idCommande,dateCommande
