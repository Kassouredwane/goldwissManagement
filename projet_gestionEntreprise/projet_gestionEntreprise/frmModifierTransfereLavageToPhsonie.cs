...
{
    public partial class frmModifierTransfereLavageToPhsonie : Form
    {
        int idTr;
        public frmModifierTransfereLavageToPhsonie(int id)
        {
            InitializeComponent();
            this.idTr = id;
        }
        private void refresh()
        {
            ...
            cn.Open();
            SqlCommand com = new SqlCommand("select * from transfereLavageToPhasonie where idtransfereLavageToPhasonie=" + idTr, cn);
        ...
        private void frmModifierTransfereLavageToPhsonie_Load(object sender, EventArgs e)
        {
            refresh();
        }
        ...
        private void btn_valider_Click(object sender, EventArgs e)
        {
            SqlConnection cn = new SqlConnection(@"Data Source=DESKTOP-F1RSPUR\SQLEXPRESS;Initial Catalog=goldwissDatabase;User ID=sa;Password=123456");
            cn.Open();
            string reqq = "update transfereLavageToPhasonie set idLavage=@idLavage,idMatla=@idMatla,qteTransfere=@qteTransfere,dateTransfere=@dateTransfere,numeroBon=@numeroBon where idtransfereLavageToPhasonie=" + idTr;
