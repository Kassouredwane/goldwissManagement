...
namespace projet_gestionEntreprise
{
    public partial class frmModifierTransferePhasonieToStock : Form
    {
        ...
        private void btn_valider_Click(object sender, EventArgs e)
        {
            SqlConnection cn = new SqlConnection(@"Data Source=DESKTOP-F1RSPUR\SQLEXPRESS;Initial Catalog=goldwissDatabase;User ID=sa;Password=123456");
            cn.Open();
            string reqq = "update phasonieStocker set idMatla=@idMatla,qteStocker=@qteStocker,dateStocker=@dateStocker,numeroBon=@numeroBon where idPhasonierStocker="+idStocker;
