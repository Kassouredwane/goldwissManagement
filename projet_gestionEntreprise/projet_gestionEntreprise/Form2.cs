...
namespace projet_gestionEntreprise
{
    public partial class Form2 : Form
    {
        ...
        private void btn_gestionMatla_Click(object sender, EventArgs e)
        {
            frmGestionMatla f = new frmGestionMatla();
            AfficherFenetre(f);
        }

        private void btn_transferePhasonieToLavage_Click(object sender, EventArgs e)
        {
            frmTransferePhasonieToLavage f = new frmTransferePhasonieToLavage();
            AfficherFenetre(f);
        }

        private void btn_transfereLavageToPhasonie_Click(object sender, EventArgs e)
        {
            frmTransfereLavageToPhasonie f = new frmTransfereLavageToPhasonie();
            AfficherFenetre(f);
        }

        private void btn_phasonieToStock_Click(object sender, EventArgs e)
        {
            frmTransferePhasonieStock f = new frmTransferePhasonieStock();
            AfficherFenetre(f);
        }

        private void btn_gestionRetour_Click(object sender, EventArgs e)
        {
            frmGestionRetour f = new frmGestionRetour();
            AfficherFenetre(f);
        }
    }
}
